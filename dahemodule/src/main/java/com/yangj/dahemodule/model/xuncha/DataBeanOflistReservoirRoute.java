...
public class DataBeanOflistReservoirRoute extends DataSupport {
    ...
    private DataBeanOflistReservoirRoute.DangerWarnPageBean dangerWarnPage;
    private List<RouteListBean> routeList;

    public DataBeanOflistReservoirRoute.DangerWarnPageBean getDangerWarnPage() {
        return dangerWarnPage;
    }

    public void setDangerWarnPage(DataBeanOflistReservoirRoute.DangerWarnPageBean dangerWarnPage) {
