 ...
 */
public class PatrolMapControlActivity1 extends BaseActivity implements
...
//                .build();
    ...
    private void startLocation() {
        gaodeHelper = new GaodeHelper(this, PatrolMapControlActivity1.class, locationOverlay, this);
        //android 6.0动态申请权限
